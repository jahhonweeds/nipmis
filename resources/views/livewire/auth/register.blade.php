...
<div class="flex flex-col gap-6">
    ...
    <form method="POST" wire:submit="register" class="flex flex-col gap-6">
        ...
        <flux:input wire:model="middlename" :label="__('Middle Name')" type="text" autofocus autocomplete="middlename"
            :placeholder="__('Middle Name')" />
        <flux:input wire:model="suffix" :label="__('Suffix')" type="text" autofocus autocomplete="suffix"
